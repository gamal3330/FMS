...
import { DatabaseSettings } from "../SettingsPage.jsx";
      ...
      <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <h2 className="mt-1 text-2xl font-black text-slate-950">إدارة قاعدة البيانات</h2>
            <p className="mt-2 max-w-4xl text-sm leading-6 text-slate-500">
              مركز تحكم مستقل للنسخ الاحتياطية، الاستعادة، الصيانة، الجداول، السجلات، وإعدادات النسخ.
            </p>
          </div>
        </div>
      </div>
      <DatabaseSettings notify={notify} />
    </section>
  );
}
