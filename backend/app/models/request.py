...
class ServiceRequest(Base):
    ...
    request_type_version_id: Mapped[int | None] = mapped_column(ForeignKey("request_type_versions.id"), index=True)
    request_type_version_number: Mapped[int] = mapped_column(Integer, default=1)
    ...
    request_type_snapshot: Mapped[dict] = mapped_column(JSON, default=dict)
    form_schema_snapshot: Mapped[list] = mapped_column(JSON, default=list)
